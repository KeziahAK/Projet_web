...
import { getAllBookDataAction, getAuthorImage} from '../services/BookAPI.js'
import AuthorGalleryOptions from "./AuthorGalleryOptions.vue"



export default {
  name: 'AuthorGalleryAction',
  components:{
    AuthorCard,
  ...
  methods: {
    ...
    async Author(){
      try {
        const allAuthorData = await getAllBookDataAction()
